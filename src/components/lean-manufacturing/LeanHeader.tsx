      ...
      <div className="bg-card text-card-foreground border-b border-border p-4 shadow-sm space-y-4 text-xs">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div className="space-y-1">
            ...
            <h1 className="text-xl font-bold tracking-tight text-foreground">Lean Manufacturing</h1>
            <p className="text-xs text-muted-foreground font-medium">
              Lean Manufacturing · <span className="font-semibold text-foreground">{record.id}</span>
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={onCloneFollowup || (() => toast.success("Cloned as Follow-up Kaizen Project!"))}>
                  <PlusCircle className="w-4 h-4 mr-2" /> Clone as Follow-up Project
                </DropdownMenuItem>
        ...
        <div className="bg-muted/50 p-3 rounded-lg border border-border/60 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div>
            ...
            <span className="font-extrabold text-foreground truncate block" title={record.leanProjectTitle}>
          ...
          <div>
            ...
            <span className="font-bold text-foreground">{record.leanProjectNumber}</span>
          </div>
        ...
        {/* Metadata Row (Second Grey Band, 7 fields - NO parent record chip) */}
        <div className="bg-muted/40 p-3 rounded-lg border border-border/40 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
          <div>
            <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">
              Plant
            </span>
            <span className="font-semibold text-foreground">{record.plant}</span>
          </div>
          ...
          <div>
            ...
            <span className="font-semibold text-foreground">{record.department}</span>
          </div>
          ...
          <div>
            ...
            <span className="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300">
          ...
          <div>
            ...
            <span className="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300">
