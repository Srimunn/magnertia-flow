...
import type { PilotAttachment } from "@/services/types";

interface PilotProductionDocumentLinksCardProps {
  attachments: PilotAttachment[];
  onViewAll?: () => void;
}

export const PilotProductionDocumentLinksCard: React.FC<PilotProductionDocumentLinksCardProps> = ({
  attachments,
  onViewAll,
}) => {
  return (
