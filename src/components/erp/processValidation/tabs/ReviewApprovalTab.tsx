    ...
    <div className="space-y-6 text-xs">
      <div className="bg-card p-4 rounded-lg border border-border flex justify-between items-center">
        <div>
          <h2 className="text-base font-bold text-foreground">
            Process Validation Executive Review Board (7-Role Sign-off)
          </h2>
          <p className="text-xs text-muted-foreground mt-0.5">
            Cross-functional approval matrix for Manufacturing Engineer, Quality Engineer, Production Manager, Process Engineer, APQP Manager, Plant Head, and COO.
          </p>
        </div>
      ...
      <div className="bg-card p-4 rounded-lg border border-border space-y-4">
        <h3 className="font-bold text-foreground pb-2 border-b border-border flex items-center gap-2">
          <UserCheck className="w-4 h-4 text-primary" /> Record Validation Approval Decision
        </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-muted-foreground font-semibold mb-1">
              Reviewer Feedback & Production Release Conditions
            </label>
            <textarea
              rows={3}
