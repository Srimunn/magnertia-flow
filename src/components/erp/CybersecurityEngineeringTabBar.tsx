...
export function CybersecurityEngineeringTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: CybersecurityEngineeringTabId;
  onTabChange?: (tabId: CybersecurityEngineeringTabId) => void;
}) {
