...
interface PfmeaReviewApprovalPanelProps {
  record: PfmeaRecord;
  onReviewDecision?: (decision: PfmeaApprovalDecision, comments: string) => void;
}

export const PfmeaReviewApprovalPanel: React.FC<PfmeaReviewApprovalPanelProps> = ({
  record,
  onReviewDecision,
}) => {
    ...
    <div className="bg-card border border-border rounded-lg shadow-sm p-3.5 text-xs space-y-3">
      <div className="flex justify-between items-center pb-2 border-b border-border">
        <div className="flex items-center gap-1.5">
          ...
          <h2 className="font-bold text-foreground text-xs">PFMEA Review Board Sign-Off</h2>
        </div>
      </div>
