...
import { Save, Send, Printer, CheckCircle2, AlertTriangle, XCircle, Award } from "lucide-react";
import type { JigRecord } from "@/services/types";

export function JigActionBar({
  record,
  onSaveDraft,
  onSubmitForReview,
  onExportReport,
  ...
  const readinessScore = record.overallJigReadiness ?? 87;
