...
export type JigDevelopmentTabId =
  | "overview"
  | "design"
  | "manufacturing"
  | "validation"
...
export interface JigDevelopmentTabItem {
  id: JigDevelopmentTabId;
  label: string;
  badge?: string | number;
}

export const JIG_DEVELOPMENT_TABS: JigDevelopmentTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "design", label: "Design", badge: "88" },
  { id: "manufacturing", label: "Manufacturing", badge: "85" },
  { id: "validation", label: "Validation", badge: "87" },
  { id: "commissioning", label: "Installation & Commissioning", badge: "86" },
...
export function JigDevelopmentTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: JigDevelopmentTabId;
  onTabChange?: (tabId: JigDevelopmentTabId) => void;
}) {
