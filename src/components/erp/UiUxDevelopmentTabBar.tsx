...
export const UI_UX_TABS: UiUxDevelopmentTabItem[] = [
  ...
  { id: "user_research", label: "User Research", badge: "3 Personas" },
  { id: "ia", label: "Information Architecture", badge: "25 Pages" },
  { id: "wireframes", label: "Wireframes", badge: "64 Screens" },
  { id: "visual_design", label: "Visual Design", badge: "System v3.2" },
  { id: "accessibility", label: "Accessibility", badge: "WCAG 2.2 AA" },
  { id: "prototype", label: "Prototype", badge: "Figma" },
  { id: "handoff", label: "Developer Handoff", badge: "90 Score" },
...
export function UiUxDevelopmentTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: UiUxDevelopmentTabId;
  onTabChange?: (tabId: UiUxDevelopmentTabId) => void;
}) {
