...
export type ProductionEngineeringTabId =
  | "overview"
  | "design"
  | "resources"
  | "validation"
...
export interface ProductionEngineeringTabItem {
  id: ProductionEngineeringTabId;
  label: string;
  badge?: string | number;
}

export const PRODUCTION_ENGINEERING_TABS: ProductionEngineeringTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "design", label: "Process Design", badge: "88 Score" },
  { id: "resources", label: "Resources", badge: "85 Score" },
  { id: "validation", label: "Validation", badge: "85 Score" },
  { id: "quality", label: "Quality & Safety", badge: "84 Score" },
  { id: "performance", label: "Performance", badge: "89 Score" },
  { id: "ai_assessment", label: "AI Assessment", badge: "87/100" },
...
export function ProductionEngineeringTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: ProductionEngineeringTabId;
  onTabChange?: (tabId: ProductionEngineeringTabId) => void;
}) {
  ...
  return (
    <div className="sticky top-[56px] z-20 flex items-center border-b border-border/80 bg-white/95 backdrop-blur-md dark:bg-slate-900/95 shadow-xs transition-colors">
      ...
      >
        {PRODUCTION_ENGINEERING_TABS.map((tab) => {
