...
import type { ControlPlanAttachment } from "@/services/types";

interface ControlPlanDocumentLinksCardProps {
  attachments: ControlPlanAttachment[];
  onViewAll?: () => void;
}

export const ControlPlanDocumentLinksCard: React.FC<ControlPlanDocumentLinksCardProps> = ({
  attachments,
  onViewAll,
}) => {
  return (
