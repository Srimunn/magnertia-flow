    ...
    <div className="bg-card text-card-foreground border-b border-border p-4 shadow-sm space-y-4 text-xs">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
        <div className="flex items-center gap-2 text-xs text-muted-foreground font-medium">
          ...
          <ChevronRight className="w-3.5 h-3.5" />
          <span className="text-foreground font-semibold">Control Plan Development</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Plus className="w-3.5 h-3.5" /> New Control Plan
          </button>
          <button
            onClick={onSaveDraft}
      ...
      <div className="flex flex-wrap items-center gap-y-3 gap-x-6 pt-1">
        <div className="min-w-[120px]">
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">Control Plan ID</span>
          <span className="font-extrabold text-foreground">{record.controlPlanId}</span>
        </div>
        ...
        <div className="min-w-[220px] max-w-[320px]">
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">Control Plan Title</span>
          <span className="font-extrabold text-foreground truncate block" title={record.controlPlanTitle}>
            {record.controlPlanTitle}
          </span>
        </div>

        <div className="min-w-[140px]">
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">Control Plan Number</span>
          <span className="font-bold text-foreground">{record.controlPlanNumber}</span>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-y-3 gap-x-6 pt-2 border-t border-border/40">
        ...
        <div className="min-w-[130px]">
          <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">PFMEA Reference</span>
          <span className="font-bold font-mono text-primary">{record.pfmeaRef}</span>
        </div>
