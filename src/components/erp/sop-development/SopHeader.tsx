      ...
      <Card className="border-border/80 shadow-xs bg-white dark:bg-slate-900 overflow-hidden">
        <CardContent className="p-5">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  <DropdownMenuItem onClick={onExportReport} className="gap-2 cursor-pointer">
                    ...
                    Export PDF / Print SOP
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => toast.success("SOP link copied to clipboard")}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 pt-4 text-xs">
            <div>
              <span className="text-muted-foreground block font-medium">SOP ID</span>
              <span className="font-bold text-foreground font-mono">{record.sopId}</span>
            </div>
            ...
            <div>
              <span className="text-muted-foreground block font-medium">SOP Title</span>
            ...
            <div>
              <span className="text-muted-foreground block font-medium">SOP Number</span>
              <span className="font-semibold text-foreground font-mono">{record.sopNumber}</span>
            </div>
            ...
            <div>
              ...
              <span className="font-semibold text-primary truncate block">{record.department}</span>
            </div>
            ...
            <div>
              ...
              <span className="font-semibold text-foreground truncate block">{record.sopCategory}</span>
            </div>
