...
export interface SopTabItem {
  id: SopTabId;
  label: string;
  badge?: string | number;
}

export const SOP_TABS: SopTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "procedure_definition", label: "Procedure Definition", badge: "12 Steps" },
  { id: "resources_requirements", label: "Resources & Requirements", badge: "8 Categories" },
  { id: "quality_compliance", label: "Quality & Compliance", badge: "90" },
  { id: "risk_safety", label: "Risk & Safety", badge: "82" },
  { id: "training_implementation", label: "Training & Implementation", badge: "88" },
  { id: "ai_assessment", label: "AI Assessment", badge: "91" },
  { id: "summary", label: "Summary" },
  { id: "review_approval", label: "Review & Approval", badge: "Under Review" },
  { id: "activity_history", label: "Activity History" },
];

export function SopTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: SopTabId;
  onTabChange?: (tabId: SopTabId) => void;
}) {
