...
export interface AssemblyLineTabItem {
  id: AssemblyLineTabId;
  label: string;
  badge?: string | number;
}

export const ASSEMBLY_LINE_TABS: AssemblyLineTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "design", label: "Layout Design", badge: "88 Score" },
  { id: "workstations", label: "Workstations", badge: "86 Score" },
  { id: "balancing", label: "Line Balancing", badge: "85 Score" },
  { id: "automation", label: "Automation & Quality", badge: "87 Score" },
  { id: "performance", label: "Performance", badge: "86 Score" },
  { id: "ai_assessment", label: "AI Assessment", badge: "88/100" },
...
export function AssemblyLineDevelopmentTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: AssemblyLineTabId;
  onTabChange?: (tabId: AssemblyLineTabId) => void;
}) {
