...
export type PilotProductionTabId =
  | "overview"
  | "design"
  | "resources"
  | "validation"
...
export interface PilotProductionTabItem {
  id: PilotProductionTabId;
  label: string;
  badge?: string | number;
}

export const PILOT_PRODUCTION_TABS: PilotProductionTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "design", label: "Design", badge: "88 Score" },
  { id: "resources", label: "Resources", badge: "85 Score" },
  { id: "validation", label: "Validation", badge: "82 Score" },
  { id: "standardization", label: "Standardization", badge: "SOP v1.2" },
  { id: "performance", label: "Performance", badge: "83 Score" },
...
export function PilotProductionTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: PilotProductionTabId;
  onTabChange?: (tabId: PilotProductionTabId) => void;
}) {
