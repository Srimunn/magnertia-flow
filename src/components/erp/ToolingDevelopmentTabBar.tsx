...
export interface ToolingTabItem {
  id: ToolingTabId;
  label: string;
  badge?: string | number;
}

export const TOOLING_TABS: ToolingTabItem[] = [
  { id: "overview", label: "Overview" },
  { id: "design", label: "Tool Design", badge: "88 Score" },
  { id: "planning", label: "Manufacturing Planning", badge: "85 Score" },
  { id: "validation", label: "Validation", badge: "87 Score" },
  { id: "readiness", label: "Production Readiness", badge: "86 Score" },
...
export function ToolingDevelopmentTabBar({
  activeTab = "overview",
  onTabChange,
}: {
  activeTab?: ToolingTabId;
  onTabChange?: (tabId: ToolingTabId) => void;
}) {
