      ...
      <div className="bg-card text-card-foreground border-b border-border p-4 shadow-sm space-y-4 text-xs">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div className="space-y-1">
            ...
            <h1 className="text-xl font-bold tracking-tight text-foreground">Robotics Integration</h1>
            <p className="text-xs text-muted-foreground font-medium">
              Robotics Integration · <span className="font-semibold text-foreground">{record.id}</span>
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={onCloneVariant || (() => toast.success("Cloned as Variant Robotics Cell!"))}>
        ...
        <div className="bg-muted/50 p-3 rounded-lg border border-border/60 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div>
            <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider block">
              Robotics Project Title
            </span>
            <span className="font-extrabold text-foreground truncate block" title={record.roboticsProjectTitle}>
        ...
        <div className="bg-muted/40 p-3 rounded-lg border border-border/40 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-0.5">
              ...
              <span className="font-bold text-foreground">{record.roboticsEngineer}</span>
            </div>
          </div>
