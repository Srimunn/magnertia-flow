...
function AssetsPage() {
  ...
  const columns: Column<Row>[] = [
    ...
    },
    {
      key: "station",
      header: "Location",
      cell: (r) => <span className="text-muted-foreground">{r.station}</span>,
    },
    {
      key: "cost",
      header: "Cost",
      align: "right",
      cell: (r) => (
        <span className="font-semibold tabular-nums">{formatCurrency(r.cost, true)}</span>
      ),
    },
    {
      key: "dep",
      ...
      cell: (r) => (
        <span className="tabular-nums text-muted-foreground">
          {formatCurrency(r.depreciated, true)}
        </span>
      ),
    },
    {
      ...
      cell: (r) => (
        <span className="font-semibold tabular-nums text-primary">
          {formatCurrency(r.cost - r.depreciated, true)}
        </span>
      ),
    },
    ...
    <AppShell>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard
          ...
          value={formatCurrency(totalDep, true)}
          icon={Boxes}
          tone="warning"
        />
        <KpiCard
          label="Net Book Value"
          value={formatCurrency(netValue, true)}
          icon={Boxes}
          tone="success"
        />
      </div>
            ...
            <>
              ...
              <div className="mt-3 grid grid-cols-3 gap-2 text-xs">
                <div>
                  ...
                  <div className="font-semibold tabular-nums">{formatCurrency(r.cost, true)}</div>
                </div>
                <div>
                  <div className="text-muted-foreground">Dep.</div>
                  <div className="tabular-nums">{formatCurrency(r.depreciated, true)}</div>
                </div>
              ...
              <button className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-primary">
