                      ...
                      <div className="card-soft p-5">
                        ...
                        <div className="space-y-3 mt-3 text-sm">
                          <div className="flex justify-between py-1.5 border-b border-border">
                            <span className="text-muted-foreground">Total Budget (USD)</span>
                            <span className="font-semibold text-foreground tabular">
                              {formatCurrency(data.summary.totalBudget)}
                            </span>
                          </div>
                          <div className="flex justify-between py-1.5 border-b border-border">
                            <span className="text-muted-foreground">Total Actual (USD)</span>
                            <span className="font-semibold text-foreground tabular">
                              {formatCurrency(data.summary.totalActual)}
                            </span>
                          </div>
                          <div className="flex justify-between py-1.5 border-b border-border">
                            <span className="text-muted-foreground">Total Commitments (USD)</span>
                            <span className="font-semibold text-foreground tabular">
                              {formatCurrency(data.summary.totalCommitments)}
                            </span>
                          </div>
                          <div className="flex justify-between py-1.5 border-b border-border">
                            <span className="text-muted-foreground">Total Forecast (USD)</span>
                  ...
                  <ul className="w-full space-y-1.5 text-xs">
                    {data.departmentSplits.map((entry, index) => (
                      <li key={index} className="flex items-center justify-between">
                        ...
                        <span className="font-semibold text-foreground">
                          {entry.percentage}% (${(entry.value / 1000000).toFixed(2)}M)
                        </span>
                      </li>
                    ))}
                  </ul>
