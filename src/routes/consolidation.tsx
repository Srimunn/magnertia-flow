    ...
    <AppShell
      ...
      topbarActions={
        <div className="flex items-center gap-2">
          <select className="rounded-lg border border-border bg-card px-3 py-1.5 text-xs text-foreground focus:outline-none">
                ...
                <div className="space-y-5">
                      ...
                      <table className="w-full text-left border-collapse text-xs">
                        <thead>
                          <tr className="border-b border-border bg-muted/20 text-muted-foreground font-semibold">
                            ...
                            <th className="p-3.5 text-right">Total Revenue (USD)</th>
                            <th className="p-3.5 text-right">Total Expenses (USD)</th>
                            <th className="p-3.5 text-right">Operating Profit (USD)</th>
                            <th className="p-3.5 text-right">Net Profit (USD)</th>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    ...
                    <div className="card-soft p-5">
                      <CardHeader title="Net Profit Trend (USD)" />
