                ...
                <table className="w-full text-xs text-left border-collapse">
                  <thead className="bg-muted text-muted-foreground sticky top-0 border-b border-border">
                    <tr>
                      ...
                      <th className="p-2.5 text-right font-semibold">Base (USD)</th>
                      <th className="p-2.5 text-right font-semibold">Comparison (USD)</th>
                      <th className="p-2.5 text-right font-semibold">Shift (USD)</th>
                    </tr>
                  </thead>
                  <tbody>
